...
export class PeriodController {
  ...
  @ApiOperation({
    ...
    description:
      'Yêu cầu quyền quản trị (Admin). Thêm mới một Period vào hệ thống.',
  })
  @ApiResponse({
  ...
  @ApiResponse({
    ...
    description: 'Dữ liệu không hợp lệ (ví dụ: endYear < startYear)',
  })
  @ApiResponse({
  ...
  @ApiOperation({
    ...
    description:
      'Hỗ trợ phân trang, tìm kiếm theo từ khóa, lọc theo trạng thái và khu vực/tỉnh thành.',
  })
  @ApiResponse({
  ...
  @ApiResponse({
    ...
    description: 'Không tìm thấy giai đoạn với ID này',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Yêu cầu quyền quản trị (Admin). Cập nhật một hoặc nhiều thuộc tính của Period.',
  })
  @ApiParam({
    name: 'id',
    description: 'UUID của giai đoạn cần sửa',
    type: String,
  })
  @ApiResponse({
    status: HttpStatus.OK,
  ...
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
    description: 'Không tìm thấy giai đoạn',
  })
  @ApiResponse({
    status: HttpStatus.BAD_REQUEST,
  ...
  @ApiParam({
    name: 'id',
    description: 'UUID của giai đoạn cần xóa',
    type: String,
  })
  @ApiResponse({
    status: HttpStatus.OK,
