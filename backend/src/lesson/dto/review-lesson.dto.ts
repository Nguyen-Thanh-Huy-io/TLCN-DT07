...
export class ReviewLessonDto {
  @ApiProperty({
    ...
    description: 'Quyết định kiểm duyệt (PUBLISHED: Cho phép xuất bản, REJECTED: Từ chối)',
  })
  ...
  @ApiProperty({
    example: 'Nội dung thiếu nguồn trích dẫn chính xác, cần làm rõ mốc thời gian...',
